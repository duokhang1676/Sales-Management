 ...
 * @author ACER
 */
public class XemPhieuNhapHangPage extends javax.swing.JPanel {
    ...
    private void addNhapHangTable() {
    	...
    	String[] colNames = {"STT", "Mã HH", "Tên HH", "Số lô","Ngày sản xuất", "Hạn sử dụng", "DVT", "Số lượng", "Giá nhập", "VAT (%)", "Chiết khấu", "Thành tiền"};
